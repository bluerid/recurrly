...
const SubscriptionCard = ({ name, price, icon, currency, billing, renewalDate, color, category, plan, onPress, paymentMethod, expanded, startDate, status }: SubscriptionCardProps) => {
  return (
          ...
          <View className='sub-details'>
            <View className='sub-row'>
              <View className='sub-row-copy'>
                ...
                <Text className='sub-value' numberOfLines={1} ellipsizeMode='tail'>{ paymentMethod?.trim() ?? 'Not Available'}</Text>
              </View>
            </View>
            <View className='sub-row'>
              <View className='sub-row-copy'>
            ...
            <View className='sub-row'>
              <View className='sub-row-copy'>
                ...
                <Text className='sub-value' numberOfLines={1} ellipsizeMode='tail'>{ status ? '' : '' }</Text>
              </View>
            </View>
          </View>
        </View>
